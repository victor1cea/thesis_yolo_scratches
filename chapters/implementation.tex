...
\begin{table}
  \centering
    \begin{tabular}{||c|c|c|c|c|c||}
    \hline
    Mode & FP count & FN count &  precision & recall & FP change\\ [0.5ex]
    \hline\hline
    $1^{st}$ stage & 16 & 2 & 0.9 & 0 & 0 \\
    $2^{nd}$ stage with one class & 10 & 2 & 0 & 0 &  -38.5\%\\
    $2^{nd}$ stage with two classes & 7 & 2 & 0 & 0 & -56.25\%\\
    \hline
    \end{tabular}
  \caption{asdf}
