...
\caption{The prominence metric in action the same scratches from figure \ref{intro:original_scratch_fades}. Weaker scratch tend to have a lower metric score.}
...
Another interesting discovery is that it's better to split the dataset after the windowing has been done. This ensures a more similar distribution between the splits. This observation alone stabilized the training experiments very much. TODO mixing is better \\
...
TODO zi ca pe primul layer doar
...
TODO show examples on cvat, show how gimp uses the lines
TODO show flips
